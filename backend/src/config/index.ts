...
const envSchema = z.object({
  ...
  REDIS_PORT: z.preprocess((val) => parseInt(val as string, 10), z.number().default(6379)),
  ...
  SMTP_PORT: z.preprocess((val) => parseInt(val as string, 10), z.number().optional()).default(587),
